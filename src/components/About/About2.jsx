...
const About2 = () => {
  return (
    <div className=' mt-56 md:mt-10 h-full w-[400%]  md:w-full '>
      ...
      <div className='card-container h-[70%]  md:w-full  mt-10 flex flex-col md:flex-row  md:justify-between gap-14 md:gap-0'>
        {data.map((item)=>{
            return <div className='card md:w-[48%] h-[90vh]  shadow-2xl hover:scale-105 duration-100 rounded-md'>
