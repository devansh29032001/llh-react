...
const Contact1 = () => {
  ...
  return (
    <div className='flex justify-between '>
      <div className='w-[40%] '>
        <h1 className='text-5xl mt-10'>Unlock your potential with LHH</h1>
        <p className='mt-10'>
      ...
      <div className='h-full  w-[55%] shadow-xl p-6 rounded-md'>
        <div className=' h-[100%] p-4'>
          <form className='flex flex-col gap-3' onSubmit={handleSubmit} id="form-container">
            ...
            <input  className="inp h-10 w-[100%] px-2 rounded-md" type="text" placeholder="First name" id="firstname" name="first" />

            {/* Last Name */}
            <label htmlFor="lastname"><h3>Last Name</h3></label>
            <input className="inp h-10 w-[100%] px-2 rounded-md" type="text" placeholder="Last name" id="lastname" name="last" />

            {/* Email */}
            <label htmlFor="email"><h3>Email</h3></label>
            <input className=" inp h-10 w-[100%] px-2 rounded-md" type="email" placeholder="Email" id="email" name="email" />

            {/* Country */}
            <label htmlFor="country"><h3>Country</h3></label>
            <input className="inp h-10 w-[100%] px-2 rounded-md" type="text" placeholder="Country" id="country" name="country" />

            {/* State */}
            <label htmlFor="state"><h3>State</h3></label>
            <select className="inp h-10 w-[100%] px-2 rounded-md" id="state" name="state" required>
            ...
            <select className="inp h-10 w-[100%] px-2 rounded-md" id="countries" name="countries" required>
            ...
            <input className=" inp h-10 w-[100%] px-2 rounded-md" type="text" placeholder="City" id="city" name="city" />

            {/* Phone Number */}
            <label htmlFor="phone"><h3>Phone Number</h3></label>
            <input className="inp h-10 w-[100%] px-2 rounded-md" type="tel" placeholder="Phone Number" id="phone" name="phone" />

            {/* Contact About */}
            <label htmlFor="options"><h3>WHAT WOULD YOU LIKE TO CONTACT US ABOUT?</h3></label>
            <select className="inp inp h-10 w-[100%] px-2 rounded-md" id="options" name="options" required>
            ...
            <textarea className="inp h-10 w-[100%] px-2 rounded-md" id="message" name="message"></textarea>
            ...
            {/* Submit Button */}
            <button type="submit" className="btn px-4 py-2 bg-blue-900 w-[40%] ">Submit</button>
          </form>
        </div>
      </div>
    </div>
