...
//     // Handle scroll behavior to show/hide the navbar
//     const handleScroll = () => {
...
//     return (
//         <>
//             {/* Apply a smooth transition effect when hiding or showing the navbar */}
//             <div
//                 className={`header fixed z-[999] top-0 bg-white w-full transition-transform duration-500 ${
...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <div
                className={`header fixed z-[999] top-0 bg-white w-full 
